...
(function () {
    ...
    var F = window, V = document, X = V.body, R = V.documentElement, A = {}, G = "", I = V.title, h = [], O = "",
        C = {}, S = V.getElementById("bdshare_js").attributes.data, K = /MSIE 6.0/.test(navigator.userAgent),
        g = V.compatMode != "CSS1Compat", S = S.nodeValue.replace(/&amp;/g, "&").split("&") || "";
    try {
    ...
    var Z = {
        ...
        _parseJson: function (j) {
            ...
            var i = [], U = inner = "", W = Z, B = W.bdList, E = W.bdNums,
            ...
            if (D && D != X) {
                if (D.getBoundingClientRect) {
                    var p = D.getBoundingClientRect(), r = q.ownerDocument, W = r.body, T = r.documentElement,
                        E = T.clientTop || W.clientTop || 0, k = T.clientLeft || W.clientLeft || 0;
                    if (p.top == p.bottom) {
        ...
        var l = /(#\d+\-[a-zA-Z\d]+\-\d+\-\d+\-[a-f\d]{32}$)/g, T = (A.search + A.hash).replace(/&/g, "#"),
            D = T.match(l) || "", o = new RegExp(Z.bdWList, "ig"),
        ...
        create: function () {
            var i = Z, k = i.bdList, D = k.length, T = [], E = "", l = J.getSize(),
                B = V.getElementById(i.bdIds + "_pop"), e = ((K || g) ? "absolute" : "fixed"), j = ((K || g) ? l.t : 0);
            if (!B) {
                while (D--) {
        ...
        bind: function (D, B, U, T) {
            ...
            var AV = Z, AC = AV.bdPic, W = AV.bdText, AA = AV.weiboText, AM = AV.wbUid, e = G, AL = AV.bdDesc,
                v = AV.bdComment, p = AV.bdMiniWindow || 0;
    ...
    bdShare.fn = (function () {
        return {
            init: function () {
                ...
                J.list_s(true);
                var i = this.b, q = this.t, D = i.length, r = q.length, B = V.getElementById(this.conf.bdIdsl),
                    E = V.getElementById("bdsIfr"), k = this.conf.bdList, n = k.length;
                ...
                var j = this, E = _bdS, n = J.getSize(), l = V.getElementById(this.conf.bdIdsl),
                    T = V.getElementById("bdsIfr"), W = (!K && !g) ? "fixed" : "absolute",
