(function () {
            ...
            s = {
                ba: function () {
                    ...
                    if (d.Ca) {
                        ...
                        f = f.pageY;
                    var y = m = 0, z = 0, A = 0;
                    if (e && (m = e.offsetWidth || e.clientWidth, y = e.offsetHeight || e.clientHeight, A = b.Ob(e), z = A.left, A = A.top, a.d(e.getBBox, "Function") && (y = e.getBBox(), m = y.width, y = y.height), "html" === (e.tagName || "").toLowerCase())) m = Math.max(m, e.clientWidth), y = Math.max(y, e.clientHeight);
                    return {
    ...
    (function () {
        ...
        function g(a) {
            var m = document, b = "";
            if (a in m) b = a; else for (var d = ["webkit", "ms", "moz", "o"], e = 0; e < d.length; e++) {
            ...
            v = t.O, k = {
                ...
                C: {Ma: "", page: ""}, init: function () {
                    ...
                    if (!(3 > b.length)) {
                        ...
                        b = d.h(b[2]);
                        if (e !== q && b !== q) {
                            var f = decodeURIComponent(s.getData("Hm_ct_" + c.id) || ""), f = a(f, e, 1, b);
        ...
        a.prototype = {
            W: function (a, b) {
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id),
                    e = b.L(document.referrer) === k.nb ? 1 : 0, f =
