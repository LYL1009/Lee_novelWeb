...
<head>
    ...
    <script type="text/javascript">
        window.onload = function () {
            var obj = document.getElementById("novelType");
        ...
        function editNovel() {
            ...
            var novelType = $("#novelType option:selected").text();
            var novelImage = $("#novelImage").val();
            var novelIntroduction = $("#novelIntroduction").val();
            $.ajax({
                url:"${lee_novelWeb}/author/editNovel",
                type:"POST",
                data:{
                    "novelId":novelId,
                    "novelName":novelName,
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="glyphicon glyphicon-th"></i> 编辑小说</h3>
                </div>
                <div class="panel-body">
                    <div class="box-body" style="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="novelName" name="novelName"
                                   value="${novel.novelName}">
                        </div>

                        <div class="form-group">
                            <label for="novelType">分类</label>
                            <select name="novelType" id="novelType" class="form-control" data-category-id="">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea id="novelIntroduction" name="novelIntroduction" class="form-control"
                                          rows="5">${novel.introduction}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="box-footer">
                        <button type="button" onclick="editNovel()" id="submit-btn"
