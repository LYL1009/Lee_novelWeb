                ...
                <div class="panel-body">
                    <form class="form-inline" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                <div style="font-size: 16px;"><strong>${novel.novelName} 第${chapterNumber+1}章</strong>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="box-footer">
                            <button type="button" onclick="updateChapter()" id="submit-btn"
                                    class="btn btn-primary fa-pull-right" data-novel-id="">发布
                            </button>
                        </div>
                    </div>
                </div>
